...
See 
- Mullan et al. *Current annotation strategies for T cell phenotyping of single-cell RNA-seq data*. Front Immunol; 2023. DOI 10.3389/fimmu.2023.1306169
- Jarousek et al. *Single-cell RNA sequencing analysis of T helper cell differentiation and heterogeneity*. Biochimica et Biophysica Acta Molecular Cell Research; 2022. DOI 10.1016/j.bbamcr.2022.119321
- seurat github issue #326, supervised clustering using `pc.genes` to input a subset of genes at the PCA stage. alternatively, `genes.use` option while tunning tSNE. 
- seurat github issue #2539, best practices for supervised clustering on a subset
